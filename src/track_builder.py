#usage example python track_builder.py -p <prefix_name> -v (verbose option) -m (median shift option) <guide_data> (output_fileName)
#usage example python track_builder.py -p Heme_R1 -v -m Heme_rep1detailed.txt Heme_rep1_detailed_bp-sig.res.txt 
